...
\section{Sobre las holomorfas}
\begin{Definition}{Cauchy Riemann}
    -- $$ f \text{ satisface cauchy riemann } \iff u_x + i v_x = v_y - i u_y $$
    -- $$ f \text{es holomorfa} \iff \text{cauchy riemann} $$
\end{Definition}

\begin{Proposition}{Caracterizacion de holomorfas}
    -- $$ f \in \mathcal{H} \iff f \in \mathcal{C}^1 \wedge \frac{\partial f}{\partial \bar{z}} $$
\end{Proposition}
